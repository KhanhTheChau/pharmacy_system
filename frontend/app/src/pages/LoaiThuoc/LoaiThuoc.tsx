...
import { faBox, faFileExport, faMagnifyingGlass } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className="col-span-1 flex flex-col gap-4">
        <div className="p-4 shadow rounded border border-[#ccc]">
          <h3 className="font-semibold mb-4">
            <FontAwesomeIcon icon={faBox} className="mr-2 w-5 h-5" />
          ...
          <div className="grid grid-cols-2 gap-2 mt-4">
            ...
            <button className={buttonClass} onClick={handleUpdateLoaiThuoc}>
              Lưu
            </button>
            <button className={buttonClass} onClick={handleDeleteLoaiThuoc}>
              Xóa
            </button>
        ...
        <div className="p-4 shadow border border-[#ccc]">
          ...
          <div className="grid grid-cols-[120px_1fr] items-center gap-2">
            ...
            <select
              ...
              onChange={(e) =>
                setSearchKey(e.target.value as keyof LoaiThuocType)
              }
            >
